...
module.exports.init = function(messageHandler, config) {
    ...
    const handleImage = async function(sessionData, msg, attachment) {
        ...
        await messageHandler.sendMessageToUser(sessionData, ":frame_photo: Nice. I received your screenshot. Now please tell me the stats. Type `help screenshot` for some help with this.")
    }
