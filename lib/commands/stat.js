...
module.exports.init = function(messageHandler, config) {
    ...
    Command.help = 'Send a stat line for the game.  You can replace a stat line by entering a new stat with the same player name again.  Use the in-game player name to match players.'
    ...
    Command.handle = async function(sessionData, msg) {
        ...
        const newPlayerDscordName = matchedPlayer === null ? null : matchedPlayer.discordName
