...
handler.loadSpreadsheetData = async function() {
    ...
    for (let scheduleRow of scheduleRows) {
        ...
        const date = scheduleRow['Date (EDT)']
    ...
    return [players, teams, teamsByGameId, scheduleByWeek, gameSubmissionStatus]
}
