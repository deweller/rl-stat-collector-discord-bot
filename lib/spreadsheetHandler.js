...
handler.loadSettings = async function() {
    ...
    if (settings.playersPerTeam != null) {
        playersPerTeam = parseInt(settings.playersPerTeam)
    }
    settings.playersPerTeam = playersPerTeam
    settings.playersPerGame = playersPerTeam * 2
