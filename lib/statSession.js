...
StatSession.init = function(client, config) {
    ...
    async function processStat(sessionData, msg) {
        ...
        await sendMessageToUser(sessionData, `:computer: I received this stat.  Type \`review\` to see all the stats you've entered or to submit a game.`)
    }
